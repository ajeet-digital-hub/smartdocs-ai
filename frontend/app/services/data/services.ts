...
export const services: Service[] = [
  ...
  // ─── Phase 6: AI Tools Extended ───
  { id: "ai-poster-maker", name: "AI Poster Maker", description: "Design professional posters with AI-powered tools", category: "Image Studio", icon: "🖼️", tags: ["poster", "ai", "design"], popular: false, trending: true, new: true },
  { id: "ai-certificate-maker", name: "AI Certificate Maker", description: "Create beautiful certificates and awards with AI", category: "Document Suite", icon: "🎓", tags: ["certificate", "award", "ai"], popular: false, trending: true, new: true },
  { id: "ai-business-card", name: "AI Business Card Designer", description: "Design professional business cards with AI", category: "Design Studio", icon: "💳", tags: ["business card", "design", "ai"], popular: false, trending: true, new: true },
...
export const getTrendingServices = (): Service[] => {
  return services.filter((s) => s.trending);
};

export const getNewServices = (): Service[] => {
  return services.filter((s) => s.new);
};
